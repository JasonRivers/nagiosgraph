...
License: OSI Artistic License 2.0 (L<http://www.opensource.org/licenses/artistic-license-2.0>)
...
=head2 Displaying Per-Service and Per-Host Graph Icons and Links in Nagios
...
=head2 Displaying Graphs in Nagios Mouseovers
...
=head2 Displaying Graphs in Nagios Frames
